...
const BAWAAN = {
  ...
  /* Siapa yang boleh membuka Webhook dan Catatan Audit selain superadmin.
     Berisi id akun LAZDigital. Kosong = hanya superadmin, dan itu memang
     keadaan yang benar sampai ada yang sengaja diberi akses. */
  aksesKhusus: {
    webhook: [],
    audit: [],
  },
